...
class MissionGenerator
  ...
  def initialize_generator(sum)
    Calyx::Grammar.new(seed: sum) do
      ...
      "Officer has serious coughing fits every few words, disrupting every sentence, and becomes increasingly angry with every request to repeat himself.",
      ...
      mission "Six Troubleshooter teams vanished in {@sector_name}. Find out what’s killing them and deal with it.",
        ...
        "Capture the highly dangerous traitor {@underdog_name} and transfer him to a far more secure location (Building {building_name}, {location.indefinite_article}). Make sure he doesn’t die; we want to save that for the *Date with Death* vidshow.",
        ...
        "Endless waves of assassination attempts will befall {@overdog_name} while he is at {@building_name}; serve as decoys to protect {@overdog_name} as he tries to protect himself.",
