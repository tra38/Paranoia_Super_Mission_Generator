  ...
  def initialize_generator(sum)
    Calyx::Grammar.new(seed: sum) do
      ...
      mission "Six Troubleshooter teams vanished in {@sector_name}. Find out what’s killing them and deal with it.",
        ...
        "{@underdog_name} was caught smuggling in a cache of EMP weaponry during a random check. The smuggler wouldn’t say who their client was; just that their client want to shut down the city once and for all as revenge. Interrogate {@underdog_name} and find out who they report to.",
        "{@overdog_name} recently issued a new loyal Mandate to improve efficiency in {@sector_name} - no more advanced AI within {@building_name} - computers are fine but robots or other autonomous robotic citizens would not be. This has divided the city into passionate groups that are at each other’s throats. Enforce {@overdog_name}'s Mandate while preventing violence.",
        ...
        "There was a failed assassination attempt on {@overdog_name} mere days after he said he was replacing half his workforce with robots. The bullet that missed laced with “uranium sugar”; a substance that rapidly burns and mutates the target from the inside out. That sounds very interesting - find out how to manufacture “uranium sugar”.",
        "Toxic crystals have begun forming on {@building_name}, shorting electrical wires and causing a miasma to settle over the city. Breaking the crystals only spreads them faster and the biotechnological specialists have no answer for these growths. Investigate these toxic crystals and come up with a solution."
