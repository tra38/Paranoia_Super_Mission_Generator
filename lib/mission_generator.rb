...
class MissionGenerator
  ...
  def initialize_generator(sum)
    Calyx::Grammar.new(seed: sum) do
      ...
      "{@underdog_name} is a prime supporter of {secret_project}, however this project is quickly running of resources. To ensure that the project can be successfully completed, {@underdog_name} is attempting to take resources away from {@building_name}. {@overdog_name}, however, is resisting {@underdog_name}'s schemes, as they do not want to lose their resources to support such a dubious endeavour.",
